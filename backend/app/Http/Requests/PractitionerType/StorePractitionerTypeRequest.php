...
class StorePractitionerTypeRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'category'    => 'required|in:Medical,Aesthetic,Wellness,Dental,Therapeutic,Other',
            ...
            'schedulingRules'                            => 'required|array',
